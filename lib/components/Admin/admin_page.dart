...
import 'package:restaurantapp/components/Admin/admin_approval_page.dart';
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              }, child: const Text('Approve Coins')),
              const SizedBox(height: 20),
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const AdminImageApprovalPage()),
                    );
                }, 
